...
from flowpower.client import PriceInterval
...
class PriceDampener:
    """Adjusts Flow Power forecast prices to reduce extreme forecast bias.

    Flow Power passes through AEMO pre-dispatch pricing which can show extreme
